...
The sections below are a detailed project reference for AI agents. The current workflow and question-authoring rules above, plus QUESTION_GUIDE.md, take precedence if details conflict.
